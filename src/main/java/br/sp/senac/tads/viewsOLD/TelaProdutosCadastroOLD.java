...
public class TelaProdutosCadastroOLD extends javax.swing.JFrame {
    
    ProdutoController produto = new ProdutoController();
    Produto prodBean = new Produto();
    
    public TelaProdutosCadastroOLD() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaProdutosCadastroOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaProdutosCadastroOLD().setVisible(true);
            }
        });
    }
