...
public class TelaClientesCadastroOLD extends javax.swing.JFrame {

    /**
     * Creates new form TelaBase
     */
    public TelaClientesCadastroOLD() {
        initComponents();
        desativar();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaClientesCadastroOLD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaClientesCadastroOLD().setVisible(true);
            }
        });
    }
